			...
			<div class="row">
				...
				<div class="col span_3">
					...
					<a id="logo" href="<?php echo home_url(); ?>" <?php echo $logo_class; ?>>
                        ...
                        <img class="stnd default-logo dark-version" alt="themenectar – Just another WordPress site" src="http://www.aslankelvin.com.br/demo/wp-content/uploads/2018/05/salient-dark-1" style="height: 24px;">
                        <img class="starting-logo default-logo" alt="themenectar – Just another WordPress site" src="http://www.aslankelvin.com.br/demo/wp-content/uploads/2018/05/starting-1.png" style="height: 24px;">
